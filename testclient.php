...
<html>
	<head>
		...
		<script src="https://showdown-server.herokuapp.com/config/config.js"></script>
		<script>
			function loadRemoteData(src) {
				var scriptEl = document.createElement('script');
				scriptEl.src = src.replace(/.*\/?data\//g, 'https://showdown-server.herokuapp.com/data/');
							...
							<div class="pmbox">
								<div class="pm-window news-embed">
									...
									<div class="pm-log" style="max-height:none">
										<div class="newsentry"><h4>Some Balance Changes</h4><p>https://drive.google.com/drive/u/0/folders/1Kaffx8VCcDkNMPtU3L4guvho92fa_nCt</p><p>&mdash;<strong>Kai</strong> <small class="date">on May 22, 2023</small></p></div>
									</div>
								</div>
							</div>
						</div>
