...
lifedew:{
anim:function(scene,_ref21){var attacker=_ref21[0],defenders=_arrayLikeToArray(_ref21).slice(1);for(var _i2=0;_i2<
...
junglehealing:{
anim:function(scene,_ref22){var attacker=_ref22[0],defenders=_arrayLikeToArray(_ref22).slice(1);
...
shelltrap:{
anim:function(scene,_ref173){var attacker=_ref173[0],defenders=_arrayLikeToArray(_ref173).slice(1);for(var _i6=0;_i6<
...
earthquake:{
anim:function(scene,_ref189){var attacker=_ref189[0],defenders=_arrayLikeToArray(_ref189).slice(1);
scene.$bg.animate({
top:-90,
bottom:0
},75).animate({
...
bulldoze:{
anim:function(scene,_ref190){var attacker=_ref190[0],defenders=_arrayLikeToArray(_ref190).slice(1);
scene.$bg.delay(275);
scene.$bg.animate({
top:-90,
bottom:0
...
springtidestorm:{
anim:function(scene,_ref202){var attacker=_ref202[0],defenders=_arrayLikeToArray(_ref202).slice(1);
scene.backgroundEffect('#FF99FF',1000,0.3);for(var _i10=0;_i10<

defenders.length;_i10++){var defender=defenders[_i10];for(var _i12=0,_ref204=
['mistball','heart'];_i12<_ref204.length;_i12++){var effect=_ref204[_i12];
for(var i=0;i<4;i++){
...
wildboltstorm:{
anim:function(scene,_ref205){var attacker=_ref205[0],defenders=_arrayLikeToArray(_ref205).slice(1);
scene.backgroundEffect('#F6D434',1000,0.3);for(var _i14=0;_i14<

defenders.length;_i14++){var defender=defenders[_i14];for(var _i16=0,_ref207=
['blackwisp','lightning'];_i16<_ref207.length;_i16++){var effect=_ref207[_i16];
for(var i=0;i<4;i++){
scene.showEffect(effect,{
x:defender.x+50,
y:defender.y-35,
...
sandsearstorm:{
anim:function(scene,_ref208){var attacker=_ref208[0],defenders=_arrayLikeToArray(_ref208).slice(1);
...
boomburst:{
anim:function(scene,_ref217){var attacker=_ref217[0],defenders=_arrayLikeToArray(_ref217).slice(1);for(var _i20=0;_i20<
...
heatwave:{
anim:function(scene,_ref218){var attacker=_ref218[0],defenders=_arrayLikeToArray(_ref218).slice(1);for(var _i22=0;_i22<
...
icywind:{
anim:function(scene,_ref245){var attacker=_ref245[0],defenders=_arrayLikeToArray(_ref245).slice(1);for(var _i24=0;_i24<
...
sludgewave:{
anim:function(scene,_ref255){var attacker=_ref255[0],defenders=_arrayLikeToArray(_ref255).slice(1);for(var _i26=0;_i26<
...
rockslide:{
anim:function(scene,_ref266){var attacker=_ref266[0],defenders=_arrayLikeToArray(_ref266).slice(1);for(var _i28=0;_i28<
...
thousandarrows:{
anim:function(scene,_ref269){var attacker=_ref269[0],defenders=_arrayLikeToArray(_ref269).slice(1);for(var _i30=0;_i30<
...
thousandwaves:{
anim:function(scene,_ref270){var attacker=_ref270[0],defenders=_arrayLikeToArray(_ref270).slice(1);for(var _i32=0;_i32<
...
scene.backgroundEffect('#BB59FF',1000,0.4);for(var _i34=0,_ref280=

['x','y',''];_i34<_ref280.length;_i34++){var axis=_ref280[_i34];
scene.showEffect('shadowball',{
...
fierywrath:{
anim:function(scene,_ref282){var attacker=_ref282[0],defenders=_arrayLikeToArray(_ref282).slice(1);for(var _i36=0;_i36<
...
makeitrain:{
anim:function(scene,_ref318){var attacker=_ref318[0],defenders=_arrayLikeToArray(_ref318).slice(1);for(var _i38=0;_i38<
...
onemillioncoinrain:{
anim:function(scene,_ref319){var attacker=_ref319[0],defenders=_arrayLikeToArray(_ref319).slice(1);for(var _i40=0;_i40<
...
surf:{
anim:function(scene,_ref326){var attacker=_ref326[0],defenders=_arrayLikeToArray(_ref326).slice(1);for(var _i42=0;_i42<
...
muddywater:{
anim:function(scene,_ref328){var attacker=_ref328[0],defenders=_arrayLikeToArray(_ref328).slice(1);for(var _i44=0;_i44<
...
lavaplume:{
anim:function(scene,_ref330){var attacker=_ref330[0],defenders=_arrayLikeToArray(_ref330).slice(1);for(var _i46=0;_i46<
...
dragonenergy:{
anim:function(scene,_ref331){var attacker=_ref331[0],defenders=_arrayLikeToArray(_ref331).slice(1);for(var _i48=0;_i48<
...
eruption:{
anim:function(scene,_ref332){var attacker=_ref332[0],defenders=_arrayLikeToArray(_ref332).slice(1);for(var _i50=0;_i50<
...
waterspout:{
anim:function(scene,_ref333){var attacker=_ref333[0],defenders=_arrayLikeToArray(_ref333).slice(1);for(var _i52=0;_i52<
...
glaciallance:{
anim:function(scene,_ref341){var attacker=_ref341[0],defenders=_arrayLikeToArray(_ref341).slice(1);
scene.backgroundEffect("url('http://raw.githubusercontent.com/mummypikachu/sprites/master/sprites/gen6bgs/bg-icecave.jpg')",1000,0.6);for(var _i54=0;_i54<
...
darkvoid:{
anim:function(scene,_ref361){var attacker=_ref361[0],defenders=_arrayLikeToArray(_ref361).slice(1);for(var _i56=0;_i56<
defenders.length;_i56++){var _defender0=defenders[_i56];
_defender0.anim({
y:_defender0.y-80,
opacity:0,
time:300
...
petalblizzard:{
anim:function(scene,_ref377){var attacker=_ref377[0],defenders=_arrayLikeToArray(_ref377).slice(1);
scene.backgroundEffect('#FF99FF',700,0.3);for(var _i58=0;_i58<

defenders.length;_i58++){var _defender1=defenders[_i58];
...
brutalswing:{
anim:function(scene,_ref395){var attacker=_ref395[0],defenders=_arrayLikeToArray(_ref395).slice(1);
scene.backgroundEffect('#000000',1300,0.3);for(var _i60=0;_i60<

defenders.length;_i60++){var _defender10=defenders[_i60];
...
astralbarrage:{
anim:function(scene,_ref411){var attacker=_ref411[0],defenders=_arrayLikeToArray(_ref411).slice(1);
scene.backgroundEffect('#000000',600,0.6);
scene.backgroundEffect('linear-gradient(#000000 10%, #2630A9)',1100,0.6,600);
...
coreenforcer:{
anim:function(scene,_ref414){var attacker=_ref414[0],defenders=_arrayLikeToArray(_ref414).slice(1);
...
defenders.length;_i64++){var _defender11=defenders[_i64];
...
clangoroussoulblaze:{
anim:function(scene,_ref434){var attacker=_ref434[0],defenders=_arrayLikeToArray(_ref434).slice(1);
attacker.anim({x:attacker.x-10,time:300});
...
defenders.length;_i82++){var _defender12=defenders[_i82];
